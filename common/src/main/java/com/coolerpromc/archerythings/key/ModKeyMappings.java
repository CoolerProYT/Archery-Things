...
public class ModKeyMappings {
    ...
    public static final Supplier<KeyMapping> OPEN_QUIVER_MENU = Services.REGISTRY.registerKeyMapping("key.archerythings.open_quiver_menu", InputConstants.Type.KEYBOARD, InputConstants.KEY_R, ARCHERY_THINGS_CATEGORY);
}
