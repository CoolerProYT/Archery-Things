...
public final class QuiverData implements TooltipProvider {
    ...
    private static QuiverData fromSlots(List<Slot> slots) {
        ...
        if (optionalint.isEmpty()) {
            ...
            for(Slot QuiverData$slot : slots) {
    ...
    static {
        CODEC = Slot.CODEC.sizeLimitedListOf(256).xmap(QuiverData::fromSlots, QuiverData::asSlots);
    ...
    record Slot(int index, ItemStack item) {
        public static final Codec<Slot> CODEC = RecordCodecBuilder.create((p_331695_) -> p_331695_.group(Codec.intRange(0, 255).fieldOf("slot").forGetter(Slot::index), ItemStack.CODEC.fieldOf("item").forGetter(Slot::item)).apply(p_331695_, Slot::new));
    }
}
